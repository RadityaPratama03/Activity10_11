...
public class TambahData extends AppCompatActivity {
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(etKode.getText().toString().isEmpty()) && !(etNama.getText().toString().isEmpty())){
                    submitBrg(new com.example.firebasebarang.Barang(etKode.getText().toString(),
                            etNama.getText().toString()));
                }else{
                    Toast.makeText(getApplicationContext(),"Data harus ada",Toast.LENGTH_LONG).show();
                }
    ...
    public void submitBrg(com.example.firebasebarang.Barang brg){
        database.child("Barang").push().setValue(brg).addOnSuccessListener(this, new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                etKode.setText("");
                etNama.setText("");
                Toast.makeText(getApplicationContext(),"Data Sudah Ditambahkan",Toast.LENGTH_LONG).show();
            }
        });
    }
