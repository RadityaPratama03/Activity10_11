                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()){
                            case R.id.edit:
                                ...
                                Intent intent = new Intent(view.getContext(), com.example.firebasebarang.BarangEdit.class);
                                ...
                                alertDlg.setMessage("Tekan 'Ya' untuk menghapus")
                                        ...
                                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                Intent i = new Intent(view.getContext(), com.example.firebasebarang.MainActivity.class);
